...
* scripts/ containing Rmarkdown/script files as following:
  ...
  * FRIC\_FunctionalMaturityFFA.Rmd: tests whether functional connectivity to/functional maturity of MMPFC, STS and amygdala correlates with functional maturity of FFA.
